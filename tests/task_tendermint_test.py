...
class TestTaskTendermintNewProposal(unittest.TestCase):
    ...
    def test_alert(self):
        c, n, t, s = buildTaskEnv(TaskTendermintNewProposal)
        TaskTendermintNewProposal.prev = """{"proposals":[{"proposal_id":"1","content":{"@type":"/ibc.core.client.v1.ClientUpdateProposal","title":"upgrade client","description":"upgrade light client","subject_client_id":"07-tendermint-0","substitute_client_id":"07-tendermint-2"},
